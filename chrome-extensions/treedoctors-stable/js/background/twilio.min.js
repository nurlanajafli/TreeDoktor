...
a[e]})(function(){var a=h("./twilio/util"),e;if("undefined"==typeof e){e=location.protocol||"http:";for(var b=""/*"https://media.twiliocdn.com/sdk/js/client/"*/,l=document.getElementsByTagName("script"),n=RegExp("(\\w+:)?(//.*)v"+a.getPStreamVersion()+"/(twilio.min.js|twilio.js)"),d=0;d<l.length;d++){var t=l[d].src.match(n);if(t){e=t[1]||e;b=t[2];break}}e+=b}a.setTwilioRoot(e);return h("./twilio")}());return b}("undefined"!==typeof Twilio?Twilio:null)},{"./twilio":2,"./twilio/util":19}],2:[function(h,m,k){k.Device=
