    ...
    $(function () {
        ...
        $(document).on('click', '[data-wizard]', function (e) {
            ...
            if ($(this).hasClass('btn-next') && !validated) {
                ...
                //added on jul 04, 2014 for featured company steps
                next.attr('disabled', (activeStep == 3) ? true : false);
                if (activeStep == 3) {
                    $('#confirm_event_start_date').html($('#event_start_date').val());
                    $('#confirm_event_end_date').html($('#event_end_date').val());
                }
            }
        });
