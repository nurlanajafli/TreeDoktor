...
window.dhtmlXScheduler = window.scheduler = {version: "4.1.0"}, window.dhtmlx || (dhtmlx = function (e) {
...
]}, highlight_displayed_event: !0, left_border: !1}, scheduler.templates = {}, scheduler.init_templates = function () {
    ...
    return (e && typeof(this.getEvent(e)[t]) != 'undefined') ? this.getEvent(e)[t] : this._userdata[t]
