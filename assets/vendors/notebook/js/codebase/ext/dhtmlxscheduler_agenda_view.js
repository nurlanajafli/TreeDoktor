...
scheduler.date.add_agenda = function (e) {
    ...
    function t() {
        ...
        for (var t = "<div class='dhx_agenda_area'>", s = 0; s < e.length; s++) {
            var i = e[s], n = i.color ? "background:" + i.color + ";" : "", a = i.textColor ? "color:" + i.textColor + ";" : "", r = scheduler.templates.event_class(i.start_date, i.end_date, i);
            t += "<div class='dhx_agenda_line" + (r ? " " + r : "") + "' event_id='" + i.id + "' style='" + a + n + (i._text_style || "") + "'><div class='dhx_agenda_event_time'>" + scheduler.templates.agenda_time(i.start_date, i.end_date, i) + "</div>", t += "<div class='dhx_event_icon icon_details'>&nbsp</div>", t += "<span>" + scheduler.templates.agenda_text(i.start_date, i.end_date, i) + "</span></div>"
        }
        ...
        var d = scheduler._els.dhx_cal_data[0].childNodes[0], o = d.childNodes[d.childNodes.length - 1];
    ...
    var n = scheduler.render_view_data;
    scheduler.render_view_data = function () {
        return"agenda" == this._mode && (scheduler._agendaScrollTop = scheduler._els.dhx_cal_data[0].childNodes[0].scrollTop, scheduler._els.dhx_cal_data[0].childNodes[0].scrollTop = 0), n.apply(this, arguments)
