...
scheduler._props = {}, scheduler.createUnitsView = function (e, t, r, s, a, i) {
    "object" == typeof e && (r = e.list, t = e.property, s = e.size || 0, a = e.step || 1, i = e.skip_incorrect, e = e.name), scheduler._props[e] = {map_to: t, options: r, step: a, position: 0}, s > scheduler._props[e].options.length && (scheduler._props[e]._original_size = s, s = 0), scheduler._props[e].size = s, scheduler._props[e].skip_incorrect = i || !1, scheduler.date[e + "_start"] = scheduler.date.day_start, scheduler.templates[e + "_date"] = function (e) {
        ...
        var r = e.position || 0, s = Math.floor((scheduler._correct_shift(+t, 1) - +scheduler._min_date) / 864e5);
        return r + s
        ...
        var r = scheduler._props[e], s = r.options;
        if (!s.length)return"";
        var a = scheduler._get_unit_index(r, t), i = s[a];
        ...
        if (t) {
            ...
            this._update_unit_section({view: t, event: s, pos: e})
        }
    ...
    var s = function (e, t) {
        if (e && "undefined" == typeof e.order[t[e.map_to]]) {
            var r = scheduler, s = 864e5, a = Math.floor((t.end_date - r._min_date) / s);
            return t[e.map_to] = e.options.length ? e.options[Math.min(a + e.position, e.options.length - 1)].key : 0;//,!0
        }
    }, a = scheduler._reset_scale, i = scheduler.is_visible_events;
    scheduler.is_visible_events = function (e) {
        ...
        var e = scheduler._props[this._mode], t = a.apply(this, arguments);
        if (e) {
            ...
            if (e.size && e.size < e.options.length) {
                var i = this._els.dhx_cal_header[0], n = document.createElement("DIV");
    ...
    scheduler._time_order = function (e) {
        ...
        var r = scheduler._props[this._mode];
        if (r && t) {
            var a = this.getEvent(e), i = this._mouse_coords(t);
            this._update_unit_section({view: r, event: a, pos: i}), s(r, a), this.event_updated(a)
        }
        return!0
    })
}();
