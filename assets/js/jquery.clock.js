...
(function(jQuery)
{
  jQuery.fn.clock = function(options)
  {
    ...
    setInterval( function() {
      var seconds = leadZero(jQuery.calcTime(opts.offset).getSeconds(), 2);
      if(opts.type=='analog')
      {
    ...
    setInterval( function() {
      var hours = leadZero(jQuery.calcTime(opts.offset).getHours(), 2);
      var meridiem = "AM";
      if(hours >= 12){
		  meridiem = "PM";
	  }
      if(hours > 12)
        hours = leadZero(hours - 12, 2);
			
      var mins = leadZero(jQuery.calcTime(opts.offset).getMinutes(), 2);
      if(opts.type=='analog')
      {
