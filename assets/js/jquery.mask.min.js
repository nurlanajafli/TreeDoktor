...
(function (g) {
    var y = function (a, h, d) {
        ...
        var c = {getCaret: function () {
            ...
            if (c && -1 === navigator.appVersion.indexOf("MSIE 10"))b.focus(), e = c.createRange(), e.moveStart("character", -b.value.length), e = e.text.length; else if (f || "0" === f)e = f;
            return e
        }, setCaret: function (e) {
            var b;
            b = a.get(0);
            ...
            events: function () {
                ...
                for (; u();) {
                    ...
                    if (r)w.match(r.pattern) ? (b[t](w), r.recursive && (-1 === q ? q = f : f === n && (f = q - m), n === q && (f -= m)), f += m) : r.optional && (f += m, l -= m), l += m; else {
                        if (!a)b[t](v);
                        w === v && (l += m);
                        f += m
                    }
