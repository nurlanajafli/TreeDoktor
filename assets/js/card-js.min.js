...
!function ($) {
    ...
    var $this = this;
    setTimeout(function(){
        $this.refreshCreditCardNumberFormat(), $this.refreshCreditCardTypeIcon(), $this.refreshExpiryMonthYearInput()
    }, 50);
    ...
    $(this.expiryMonthYearInput).trigger('keydown');
    ...
    }), this.cardNumberInput.on("paste blur", function () {
        setTimeout(function () {
            $this.refreshCreditCardNumberFormat(), $this.refreshCreditCardTypeIcon(), setTimeout(function () {
                $this.refreshExpiryMonthYearInput(), $($this.expiryMonthYearInput).trigger('keydown');
            }, 50)
        }, 1)
    })
