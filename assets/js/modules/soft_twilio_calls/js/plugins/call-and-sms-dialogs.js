...
jQuery(function($) {	
	...
	$(document).on('click', '.twilio-call', function(e) {
		e.preventDefault();
	...
	$(document).on('click', '#vbx-client-status .client-button', function(e) {
		e.preventDefault();
		e.stopPropagation();
...
jQuery(function($) {
	...
	$(document).on('submit', 'form, .sms-dialog', function(event) {
	...
	$('.twilio-sms').each(function () {
		...
		$(document).on('click', '.close, .sms-dialog', function(event) {
			hideDialog(event, link);
			event.preventDefault();
		});
	...
	$(document).on('click', '.send-sms-button, .sms-dialog', smsNumber);
	...
	$(document).on('keypress', 'textarea, .sms-dialog', updateCount);
	$(document).on('keyup', 'textarea, .sms-dialog', updateCount);
	$(document).on('load', 'textarea, .sms-dialog', updateCount);
