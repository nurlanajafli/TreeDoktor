...
$(document).ready(function() {
	...
	$(document).on('keyup', '.quick-sms-popup input[name="content"]', updateCount);
	$('.quick-sms-popup input[name="content"]').keypress();
	$(document).on('keyup', '#reply-sms textarea', updateCount);
	$(document).on('keyup', '#reply-sms textarea', updateCount);
	$('#reply-sms textarea').keypress();
	$(document).on('click', '#reply-sms .submit-button', function(event) {
		event.preventDefault();
	...
	$(document).on('click', '.assign-user-list .user a', function(event) {
		event.preventDefault();
		var anchor = $(this);
