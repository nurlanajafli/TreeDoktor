var EmailTags = function() {
        ...
        select2: [{
            ...
            options: {
                ...
                containerCssClass: function (obj) {
                    return 'email-tags-dropdown-container pull-right';
                },
                ...
                //dropdownCss:'',
                dropdownCssClass: "email-tags-dropdown",
            ...
            values: window.email_tags ? window.email_tags : [],
    ...
    var _private = {
        ...
        init_select2: function () {
            ...
            /*console.log(Common.init_select2(config.select2));*/
        }
    };
    var public = {
