$(document).ready(function(){
	...
	$(document).on('usergroup-selected', ".dial-applet .usergroup-container", function(e, usergroup_label, type){
	...
	$(document).on('change', ".dial-applet input.dial-whom-selector-radio", function (e) {
	...
	$(document).on('click', ".dial-applet input.no-answer-action-radio,.dial-applet input.dial-whom-selector-radio", function(event) {
