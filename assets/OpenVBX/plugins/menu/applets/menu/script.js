$(document).ready(function () {
    ...
    $(document).on('keyup', '.menu-applet input.keypress', function (event) {
        var row = $(this).closest('tr');
        $('input[name^="keys"]', row).attr('name', 'keys[' + $(this).val() + ']');
        $('input[name^="choices"]', row).attr('name', 'choices[' + $(this).val() + ']');
    });

    $(document).on('click', '.menu-applet .action.add', function (event) {
    ...
    $(document).on('click', '.menu-applet .action.remove', function (event) {
        event.preventDefault();
        event.stopPropagation();
        var row = $(this).closest('tr');
    ...
    $(document).on('change', '.menu-applet .options-table', function () {
