...
if(isset($_SERVER['HTTP_HOST'])) {
	...
	$config['base_url'] = "https://arborcare.arbostar.com/";
}
/*
|--------------------------------------------------------------------------
| Index File
...
|
*/
$config['sess_cookie_name'] = 'vitree_session';
...
$config['account_email_address'] = 'service@vitree.ca';

/* Added into db config */
$config['office_address'] = '1495 Wilson Road';
$config['office_region'] = '';
$config['office_city'] = 'Nanaimo';
$config['office_state'] = 'BC';
$config['office_zip'] = 'V9R 6R3';
$config['office_country'] = 'Canada';
$config['office_description'] = '';
/* Added into db config */

$config['office_address_map'] = '1495+Wilson+Rd,+Nanaimo,+BC+V9R+6R3';
$config['office_phone'] = '+12506187914';
$config['office_phone_mask'] = '(250) 618-7914';
$config['office_fax'] = '250-618-7914';
$config['company_site'] = 'http://vitree.ca/';
$config['company_site_http'] = 'http://vitree.ca/';
$config['company_site_name'] = 'vitree.ca';
$config['company_site_name_upper'] = 'Vitree.ca/';
