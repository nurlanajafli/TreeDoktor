...
if(isset($_SERVER['HTTP_HOST'])) {
	...
	$config['base_url'] = "https://arborcare.com/";
}
/*
|--------------------------------------------------------------------------
| Index File
...
|
*/
$config['sess_cookie_name'] = 'arborcare_session';
...
$config['account_email_address'] = 'trees@arborcare.arbostar.com';

/* Added into db config */
$config['office_address'] = '10100 114 Ave SE';
$config['office_region'] = '';
$config['office_city'] = 'Calgary';
$config['office_state'] = 'Alberta';
$config['office_zip'] = 'T3S 0A5';
$config['office_country'] = 'Canada';
$config['office_description'] = '';
/* Added into db config */

$config['office_address_map'] = '10100+114+Ave+SE+Calgary+T3S+0A5';
$config['office_phone'] = '+14032736378';
$config['office_phone_mask'] = '(403) 273-6378';
$config['office_fax'] = '403-272-1536';
$config['company_site'] = 'https://www.arborcare.com/';
$config['company_site_http'] = 'http://www.arborcare.com/';
$config['company_site_name'] = 'arborcare.com';
$config['company_site_name_upper'] = 'Arborcare.com';
