...
defined('SITE_NAME') OR define('SITE_NAME', 'Tree Doctors');
defined('PICTURE_PATH') OR define('PICTURE_PATH', 'assets/treedoctors/pictures/');
...
defined('_CC_MAX_PAYMENT') OR define("_CC_MAX_PAYMENT", 2000);
...
defined('INVOICE_TERM') OR define("INVOICE_TERM", 30);
defined('INVOICE_INTEREST') OR define("INVOICE_INTEREST", 2);
...
defined('AWS_KEY') OR define('AWS_KEY', 'AKIAV7WCIUMYOMNT3YQV');
defined('AWS_SECRET_KEY') OR define('AWS_SECRET_KEY', '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');
// NB! bucket name to be immutable, and set same way as credentials
defined('S3_BUCKET_NAME') OR define('S3_BUCKET_NAME', 'one.arbostar');
defined('AWS_REGION') OR define('AWS_REGION', 'us-east-2');
defined('AWS_VERSION') OR define('AWS_VERSION', 'latest');
defined('PUSHY_SECRET_KEY') OR define('PUSHY_SECRET_KEY',
    '4177c6df466b67b1e111f687527160e377ed8db99eb5d7147fc5bfd95ffcc771');
...
defined('DISTANCE_MEASUREMENT') OR define('DISTANCE_MEASUREMENT', 'km');
