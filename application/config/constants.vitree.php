...
define('SITE_NAME', 'Vitree');
define('PICTURE_PATH', 'assets/vitree/pictures/');
...
define('_ADMIN_EMAIL', "accounting@vitree.ca");
define('_ADMIN_NAME', "Vitree Team");
...
define('S3_BUCKET_NAME', 'vitree.arbostar');
