...
namespace application\core\Queue\Jobs;

use Illuminate\Container\Container;
use Illuminate\Queue\Jobs\Job;
use Illuminate\Contracts\Queue\Job as JobContract;
use application\core\Queue\DatabaseQueue;
...
class DatabaseJob extends Job implements JobContract
{
     ...
     *
     * @var \application\core\Queue\DatabaseQueue
     */
    protected $database;
     ...
     * @param  \application\core\Queue\DatabaseQueue  $database
     * @param  \stdClass  $job
