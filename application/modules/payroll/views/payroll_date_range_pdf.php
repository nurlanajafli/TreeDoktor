...
<div style="">
	<div class="holder p_top_20">
		<img src="<?php echo base_url('assets/' . $this->config->item('company_dir') . '/print/header2.png'); ?>" width="100%" height="20%" class="p-top-20" style="margin-left: 0px; float: left">
	</div>
	<div style="margin: 0 20px 0; width: 93%; border: 0;">
		<div class="panel-default p-n" style="max-height: 90%; overflow-y: auto; overflow-x: hidden; border-radius: 0; margin-bottom: 0; border: 0;">
					...
					<table class="table" style="width: 55%;margin-bottom: 0px;">
						...
						<tr>
							...
							<td class="text-center b-a" style="white-space: nowrap;padding: 0;">
								<?php $address = $employee['emp_address1'] ?? ''; ?>
								<?php $address .= $employee['emp_city'] ?? ''; ?>
								<?php $address .= $employee['emp_state'] ?? ''; ?>
			...
			<?php $this->load->view('payroll_date_range_workspace'); ?>
		</div>
