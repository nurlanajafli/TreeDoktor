            ...
            <section class="scrollable wrapper">
                ...
                <div class="row twilio-index-content">
                    ...
                    <div class="col-lg-10 p-left-0">
                        <?php $this->load->view('settings/integrations/twilio/workflow/list', [
                            'workflows' => $workflows,
...
<script src="<?php echo base_url(); ?>assets/js/modules/soft_twilio_calls/js/workflow.js"></script>
