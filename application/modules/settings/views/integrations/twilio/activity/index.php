            ...
            <section class="scrollable wrapper">
                ...
                <div class="row twilio-index-content">
                    ...
                    <div class="col-lg-10 p-left-0">
                        <?php $this->load->view('settings/integrations/twilio/activity/list', [
...
<div id="activity-delete">
    <div id="activityModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-content">
                <form name="modalDeleteNotify" action="">
                    <div class="modal-body">
                        ...
                        <p class="hidden form-attribute-invalid error"></p>
                    </div>
...
<script src="<?php echo base_url(); ?>assets/js/modules/soft_twilio_calls/js/activity.js"></script>
