...
<div class="column_holder">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" autosize="1">
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance_1_holder" style="width: 220px; margin-left: -20px; margin-right: 30px;">
                    <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance" autosize="1" style="margin-top: 20px; margin-right: -30px;">
                    <tr>
                        <td align="left">
            ...
            <pagebreak>
                <div style="width:100%;padding-left: 60px;  padding-right:30px">
                    ...
                    <?php foreach ($files as $key => $pathes) : ?>
                        ...
                        <?php if($counter && !($counter % 4) && (isset($pathes[$jk + 1]) || isset($files[$key + 1]))) : ?><pagebreak><?php endif; ?>
                        <div style=" position:absolute; width:47%; padding-left: 15px; float:left; display:block;">
