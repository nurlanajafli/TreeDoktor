...
<div class="holder"><img
            src="<?php echo base_url($estimate_logo); ?>"></div>
...
<div class="column_holder">
    <?php if(config_item('show_estimate_pdf_requirements_block')) : ?>
                                ...
                                <div class="column" style="margin-left: -25px;">
                                    ...
                                    <?php foreach (array_unique($crewsData, SORT_REGULAR) as $key => $serviceCrew) : ?>
                                        <?php foreach ($serviceCrew as $serviceCrewUnit) : ?>
                                            <?php if(!in_array($serviceCrewUnit, $crews)) : ?>
        ...
        <tr>
            <td width="100%" align="center">
                <div class="thank_you">
                    ...
                    quotation. <br>
                    Accepted Payments: <span class="green"> VISA, MasterCard, AMEX, DISCOVER</span>
                </div>
            </td>
        </tr>
    </table>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" autosize="1">
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance_1_holder" style="width: 220px;">
                    <tr>
                        ...
                        <td class="acceptance_1_text"><span class="acceptance_1_title"><strong>Acceptance of
                            ...
                            <span class="acceptance_1_fineprint" valign="top">The above prices, specifications and conditions are satisfactory and hereby accepted. <?php echo (brand_name($brand_id))?brand_name($brand_id):$this->config->item('company_name_short'); ?> is authorized to do the work as specified.
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance" autosize="1" style="margin-top: 20px; ">
                    <tr>
                        <td align="left">
...
<div class="address" style="position: absolute; right: 0; left: 0; text-align: center;">
...
<?php if(isset($brand_id) && $brand_id): ?>
    <?php if(strip_tags($estimate_terms, ['img'])): ?>
        ...
        <?php if($pdf_footer): ?>
            <div class="address" style="position: absolute; right: 0; left: 0; text-align: center;"><?php echo $pdf_footer; ?></div>
        <?php endif; ?>
    <?php endif; ?>
<?php
    else:
...
<?php endif; */ ?>
            ...
            <pagebreak>
                <div style="width:100%;padding-left: 60px;  padding-right:30px">
                    <?php $counter = 0;
                    ...
                    <?php foreach($pathes as $jk=>$file) : ?>
                        <?php if($counter && !($counter % 4) && (isset($pathes[$jk + 1]) || isset($keys[array_search($key, $keys)+1]))) : ?><pagebreak><?php endif; ?>
                        <?php $full_width = (strripos($file,'_scheme') !== false || strripos($file,'_tree_inventory') !== false);?>
                        <div style=" position:absolute; width:<?php if($full_width): ?>100<?php else: ?>47<?php endif; ?>%; padding-left: 15px; float:left; display:block;">
                            ...
                            <?php elseif(strripos($file,'_scheme') !== false) : ?>
                                <div class=""><br><strong>Project Scheme</strong></div>
                            <?php elseif(strripos($file,'_tree_inventory') !== false) : ?>
                                <div class=""><br><strong>Tree Inventory Map</strong></div>
