...
<?php //echo($estimate_data->estimate_hst_disabled); ?>
<?php //echo($estimate_data->estimate_tax_value); ?>
                                        ...
                                        <?php if (isset($equipments) && count($equipments)) : ?>
                                            <?php foreach ($equipments as $jequp) : ?>
                                                <?php foreach ($jequp as $equipment) : ?>
                                                    <?php if (isset($equipment['name']) && trim($equipment['name']) != '' && array_search($equipment['name'], $setups) === FALSE) : ?>
                                                        <tr>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if ($equipment['name'] != '' && isset($equipment['opts']) && $equipment['opts'] != '' && array_search($equipment['opts'], $opts) === FALSE) : ?>
                                                        <tr>
                                                            <td valign="center" width="40px">
                                                                <img src="<?php echo base_url(); ?>assets/<?php echo $this->config->item('company_dir'); ?>/print/check_yes.png"
                                                                     height="13">
    ...
    <table width="100%" style="margin-top: 0px;">
        <tr>
            <td width="100%" align="center">
                <div class="thank_you">
                    <?php if(config_item('estimate_pdf_thank_you_block') === null) : ?>
                    ...
                    quotation.
                    <?php else : ?>
                    <?php echo config_item('estimate_pdf_thank_you_block') ?>
                    <?php endif; ?>
                </div>
            </td>
        </tr>
    </table>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" autosize="1" class="acceptance_table">
        <tr>
            <td>
            ...
            <?php if (isset($files) && $files && !empty($files)) :  ?>
                    <?php foreach ($files as $key => $pathes) : ?>
                        ...
                        <div style="padding-left: 75px; padding-right: 30px; position:absolute">
                            ...
                            <?php if (!is_file($file)) : ?>
                                <img rotate="<?php /*echo getRotation('./' . $file);*/ ?>" style="max-height: 950px;" src="<?php echo base_url(implode('/', array_map('urlencode', explode('/', $file)))); ?>">
                            <?php else : ?>
                                <img rotate="<?php echo getRotation($file); ?>" style="max-height: 950px;" src="<?php echo base_url(implode('/', array_map('urlencode', explode('/', $file)))); ?>">
                            <?php endif; ?>
