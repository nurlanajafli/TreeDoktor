...
<div class="estimate_number">
	<div class="estimate_number_1">Total Payable</div>
	<div class="estimate_number_2"><?php echo money($estimate_data->total_due); ?></div>
</div>
<?php endif; ?>
...
<div class="data">
	<div class="min_height_350" <?php if($invoice_watermark): ?>style="background-image: url('<?php echo base_url($invoice_watermark); ?>')!important;"<?php endif; ?>>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="invoice_table" width="100%">
			...
			<?php endif; ?>
			<?php if ($estimate_data->estimate_hst_disabled != 1 && $estimate_data->estimate_tax_name && $estimate_data->estimate_tax_value && $estimate_data->estimate_tax_value != '0') : ?>
				<tr>
					<td valign="middle" align="right"
					    class="small_arrow"<?php if ($estimate_data->estimate_hst_disabled == 1) : ?> style="text-decoration: line-through;"<?php endif; ?>>
						<?php echo /*$estimate_data->estimate_tax_name . ' ' . */ 'Tax:'; ?>
					</td>
					<td valign="middle"
			...
			<tr>
				...
				<td valign="middle" align="right" width="130px">
...
<div class="thank_you" style="font-size: 14px; margin-top: 0; margin-right: 40px; font-family: Arial, Helvetica, sans-serif; text-align: right;">Estimator: <?php echo $estimate_data->firstname . ' ' . $estimate_data->lastname; ?></div>
<div class="thank_you" style="font-size: 20px; margin-top: 5px; font-family: Arial, Helvetica, sans-serif;">Thank you for your business!</div>
