...
<pagebreak>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 5px 0; border-bottom: 1px solid #000;">
		<tr>
			<td width="35%" valign="top">
				<table cellpadding="0" cellspacing="0" border="0">
					<tbody>
					<tr>
						<td width="100px" valign="top">Date:</td>
						<td valign="top"><?php echo getDateTimeWithDate($workorder_data->date_created, "Y-m-d"); ?></td>
					</tr>
					<tr>
						<td valign="top">Client:</td>
						<td valign="top"><?php echo $client_data->client_name; ?></td>
					</tr>
					<tr>
						<td valign="top">Client Phone:</td>
						<td valign="top"><?php echo isset($client_contact['cc_phone']) && $client_contact['cc_phone'] ? numberTo($client_contact['cc_phone']) : ''; ?></td>
					</tr>
					<?php if (isset($client_contact['cc_name']) && $client_data->client_contact != $client_contact['cc_name']) : ?>
						<tr>
							<td>Contact Person:</td>
							<td><?php echo $client_contact['cc_name']; ?></td>
						</tr>
			...
			<td width="33%" valign="top">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td valign="top"> <?php echo $estimate_data->lead_address . ", " . $estimate_data->lead_city; ?>
							<br>
							<?php echo $estimate_data->lead_state . ", " . $client_data->client_country ?><br>
							<?php echo $estimate_data->lead_zip; ?>
						</td>
					</tr>
				</table>
			</td>
			<td>
				...
				<img
					src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $tags; ?>+<?php echo $estimate_data->lead_city; ?>+<?php echo $estimate_data->lead_state; ?>+<?php echo $client_data->client_country; ?>&zoom=12&size=250x90&markers=<?php echo $tags; ?>+<?php echo $client_data->client_city; ?>+<?php echo $client_data->client_state; ?>+<?php echo $client_data->client_country; ?><?php echo $mapKey; ?>"
					alt="Google Map" height="90" width="230" style="margin-top: -10px;">
			</td>
		</tr>
	</table>
	...
	<div>
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td width="68%">
					PROJECT OR WORK ACTIVITY<br>
					<?php echo implode(', ', array_unique($servicesNames)); ?><br><br>
					NEAREST HOSPITAL: <?php echo $hospital_name . ' - ' . $hospital_address; ?>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="m-t-10">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<th width="75%" class="hazards-th"><strong>HAZARDS</strong></th>
				<th class="controls-th"><strong>CONTROLS</strong></th>
			</tr>
			<tr>
				<td class="hazards-td">
					<table cellpadding="0" cellspacing="0" border="0" width="100%" class="hazards-table">
						<tr>
							<td style="padding: 0;"><strong>Access / Work Location Hazards</strong></td>
							<td><strong>Activity / Equipment / Tool Hazards</strong></td>
							<td><strong>Work Environment Hazards</strong></td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Partially obstructed
							</td>
							<td>
								<input type="checkbox"> Burn / Heat sources
							</td>
							<td>
								<input type="checkbox"> Spill potential
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Slip / Trip potential
							</td>
							<td>
								<input type="checkbox"> Equipment / tools
							</td>
							<td>
						...
						<tr>
							<td>
								<input type="checkbox"> Below Grade / Above Grade (circle one)
							</td>
							<td>
								<input type="checkbox"> Airborne particles / chipping / grinding
							</td>
							<td>
								<input type="checkbox"> Heat Stress / Cold exposure
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Near Vehicle / Equipment
							</td>
							<td>
								<input type="checkbox"> Activity creates vibration / noise / light hazard
							</td>
							<td>
								<input type="checkbox"> Other workers in area
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Other persons above or below work area
							</td>
							<td>
								<input type="checkbox"> Tools / Equipment not serviceable
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<input type="checkbox"> Tools / Equipment not appropriate
							</td>
							<td>
								<input type="checkbox"> Loose materials
							</td>
						</tr>
						...
						<tr>
							...
							<td><strong>Personal Limitations / Hazards</strong></td>
							<td><strong>Ergonomic Hazards</strong></td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Health Hazards
							</td>
							<td>
								<input type="checkbox"> Distractions in work area
							</td>
							<td>
								<input type="checkbox"> Working in tight area
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="checkbox"> Working alone (communication)
							</td>
							<td>
								<input type="checkbox"> Working over your head
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="checkbox"> Lift too heavy / awkward position
							</td>
							<td>
								<input type="checkbox"> Repetitive motion
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Other _________________________________
							</td>
							<td>
								<input type="checkbox"> External noise levels
							</td>
							<td>
								<input type="checkbox"> Repetitive work in awkward position
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="checkbox"> Other _______________________________________
							</td>
							<td>
				...
				<td class="controls-td">
					<table cellpadding="0" cellspacing="0" border="0" width="100%" class="controls-table">
						<tr>
							<td><strong>Shutdowns / Permits / Tags</strong></td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Safe Work Procedure Reviewed
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Working at Heights Planning Card
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Equipment Log / Checklist
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Locates valid
							</td>
						</tr>
						...
						<tr>
							<td><strong>PPE Requirements</strong></td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> CSA Approved hard hat
							</td>
						</tr>

						<tr>
							<td>
								<input type="checkbox"> Safety boots
							</td>
						</tr>
						...
						<tr>
							<td>
								<input type="checkbox"> High-Visibility Garment
							</td>
						</tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr>
			<td width="33%" align="center"><strong>TASKS</strong></td>
			<td width="33%" align="center"><strong>HAZARDS</strong></td>
	...
	<br>
	<br>
	<div><strong>ATTENDEES NAME: </strong></div>
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr><td>&nbsp;</td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>&nbsp;</td></tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr>
			<td width="20%">&nbsp;</td>
            <td width="40%" align="center"><strong>print name</strong></td>
            <td width="20%" align="center"><strong>date</strong></td>
            <td width="20%" align="center"><strong>signature</strong></td>
		</tr>
		<tr>
