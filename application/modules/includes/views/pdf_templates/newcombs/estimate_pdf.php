...
<head>
    ...
    <style type="text/css">
        ...
        @page {
            ...
            .column_holder .terms_block {
                padding: 5px 0 0 0px;
            }
            .column_holder .terms_block .title {
                margin-left: 0;
            }
            .column_holder .terms_block .title_1 {
                padding-left: 0;
            }
            .column_holder .terms_block .des_1 {
                padding-left: 20px;
            }
            .float-left{
                float:left;
...
<body>
<div class="holder p_top_20" style="text-align:center"><img width="170"
            src="<?php echo base_url($estimate_logo); ?>"
            style="<?php //echo $this->config->item('company_header_pdf_logo_styles'); ?>"
            class="p-top-20"></div><br>
<div class="estimate_number" style="text-align:center; margin-top: 0;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="client_table">
        ...
        <?php if ($client_data->client_address != $estimate_data->lead_address) : ?>
            <tr>
                ...
                <td><?php echo $estimate_data->lead_address . " " . (isset($estimate_data->lead_city) && !empty($estimate_data->lead_city) ? $estimate_data->lead_city : ''); ?></td>
            </tr>
        <?php endif; ?>
        ...
        <tr>
            <td width="100%" align="center">
                <div class="thank_you">
                    ...
                    quotation. <br>
                    You may also email a signed copy of the estimate to <span class="green"><?php echo brand_email($brand_id); ?></span>.
                </div>
            </td>
        </tr>
    </table>
...
<?php endif; */ ?>
            ...
            <?php if (isset($files) && $files && !empty($files)) :  ?>
                    ...
                    <?php foreach ($files as $key => $pathes) : ?>
                        ...
                        <pagebreak>
                        <div style="padding-left: 25px; padding-right: 30px; position:absolute">
