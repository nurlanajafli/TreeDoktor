...
<body>
<div class="holder" style="text-align:center;"><img class="top_logo" src="<?php echo base_url($invoice_logo); ?>" width="170"></div>
<?php if(isset($invoice_data) && $invoice_data) : ?>
<div class="estimate_number" style="padding-top:20px;">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="client_table">
		...
		<?php if ($client_data->client_address != $estimate_data->lead_address) : ?>
			<tr>
				...
				<td><?php echo $estimate_data->lead_address . " " . $estimate_data->lead_city; ?></td>
			</tr>
		<?php endif; ?>
