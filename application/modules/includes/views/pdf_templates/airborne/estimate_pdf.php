...
<div class="data">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="client_table">
        ...
        <tr>
            <td>Add. Info:</td><td><?php echo $client_data->client_main_intersection; ?></td>
        </tr>>
        <?php endif; ?>
        <tr>
            <td>Client Phone:</td>
        ...
        <?php if(isset($estimate_data->lead_add_info) && $estimate_data->lead_add_info != '' && (isset($client_data->client_main_intersection) && $estimate_data->lead_add_info != $client_data->client_main_intersection)) : ?>
            <tr>
                <td>Add. Info:</td><td><?php echo $estimate_data->lead_add_info; ?></td>
            </tr>
        <?php endif; ?>
        ...
        <tr>
            <td width="100%" align="center">
                <div class="thank_you">
                    ...
                    This quote is valid for a period of 30 days following the date of estimate.  <br/>
