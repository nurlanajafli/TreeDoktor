...
<head>
    ...
    <link rel="stylesheet"
          href="https://treenewal.arbostar.com/assets/treenewal/css/estimate_pdf.css"
...
<div class="holder p_top_20" style="text-align: right; font-size: 1.2em; font-family: sans-serif; float:right;">
  <div style="<?php echo $this->config->item('company_header_pdf_logo_styles'); ?>" class="p-top-20">
        <img src="<?php echo base_url($estimate_logo); ?>" style="max-width:450px; max-height: 120px; margin-bottom:20px;" >
        <br />(817) 329-2450</div>
</div>

<div class="estimate_number">
    <div class="estimate_number_1">Estimate #</div>
        ...
        <div class="estimate_table">
            ...
            <div class="m-t-5">
                ...
                <div class="pull-left text-right">
                    <!--<img src="<?php echo base_url(); ?>assets/<?php echo $this->config->item('company_dir'); ?>/print/total_star.png"
                         height="20">-->
...
<div class="column_holder">
    <div class="estimate_requirements_block">
        <table width="100%">
            <tr>
                <td width="100%">
                    <table width="100%">
                        <tr>
                            ...
                            <?php endif; ?>
                            <?php if ((isset($project) && count($project) && in_array(true, $project)) || $estimate_data->full_cleanup == 'yes' || $estimate_data->brush_disposal == 'yes' || $estimate_data->leave_wood == 'yes') : ?>
    ...
    <table width="100%" style="margin-top: 0px;">
        <tr>
            <td width="100%" align="left">
                <div class="thank_you" style="font-size: 0.8em;">
                    <br/>
                    <strong>AII services are performed in accordance with ANSI A300 Tree Care Standards and ANSI Z133, and OSHA Safety Standards. <font style="color: red;">* * This Estimate is valid for 30 days from the date of Estimate. * *</font></strong><br/><br/>
                    For every tree we service, we donate one tree planted through the National Forest Foundation.</strong> <b>TreeNewal Donations:</b></br>
                    <p>
                    ...
                    We thank you for the opportunity to be a part of your tree care and hope you will join us in our mission of sustainability.<br/><br/>
                </div>
            </td>
        </tr>
    </table><br/>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" autosize="1">
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance_1_holder" style="max-width:220px; margin-left: -20px;">
                    <tr>
                        <td class="arrow" valign="top"><img
                                src="<?php echo base_url(); ?>assets/<?php echo $this->config->item('company_dir'); ?>/print/arrow.png"
                                width="30" height="30"></td>
                        <td class="acceptance_1_text"><span class="acceptance_1_title"><strong>ACCEPTANCE OF ESTIMATE: </strong></span><br>
                            <span class="acceptance_1_fineprint" valign="top">Your signature acknowledges you have read and agreed to the TERMS & CONDITIONS herein and accept the pricing and work specifications listed within this Estimate.
                            <br>Please sign and email to <a href="mailto:<?php echo (brand_email($brand_id))?brand_email($brand_id):$this->config->item('account_email_address'); ?>" target="_blank"><?php echo (brand_email($brand_id))?brand_email($brand_id):$this->config->item('account_email_address'); ?></a> or click on the link within the email this Estimate was sent.
                                        </span>
                        </td>
                    </tr>
                </table>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="acceptance" autosize="1" style="margin-left: 20px;margin-right: -20px;">
                    <tr>
                        <td align="left">
                            <table cellpadding="0" cellspacing="0" border="0" class="acceptance_2">
                                <tr>
                                    ...
                                    <td width="130px">&nbsp;<strong>Date:</strong>&nbsp;
                                        <?php //echo $estimate_data->estimate_review_date;//date('Y-m-d', $estimate_data->date_created); ?>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="acceptance_2">
                                ...
                                <tr>
                                    <td align="left" style="position: relative;">
                                        <strong><?php echo $client_data->client_name; ?> / Signature</strong>
                                        <?php $signed = FALSE; ?>
                                        <?php if(is_bucket_file('uploads/clients_files/' . $estimate_data->client_id . '/estimates/' . $estimate_data->estimate_no . '/signature.png')) : ?>
                                        <?php $signed = TRUE; ?>
                                      <?php else : ?>   <br><br>________________________________
                                        <?php endif; ?>
                                    </td>
                                    <td width="130px">&nbsp;<strong>Date:</strong> <?php if(!$signed) : ?> ____________ <?php else : ?>  &nbsp;<?php echo getDateTimeWithDate($estimate_data->workorder_date_created, 'Y-m-d'); ?> <?php endif; ?></td>
                                </tr>
                            </table>
                            <br/><br/>
                        </td>
...
<?php
if(strip_tags($estimate_terms, ['img'])): ?>
    <pagebreak>
    <div>
