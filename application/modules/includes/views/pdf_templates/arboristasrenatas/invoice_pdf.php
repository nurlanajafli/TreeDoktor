...
<div class="holder" style="position: absolute; top: 0; right: -45px;"><img class="top_logo" src="<?php echo base_url($invoice_logo); ?>" style="max-height: 120px; max-width: 200px;"></div>
...
<div class="data">
	<div class="min_height_350" <?php if($invoice_watermark): ?>style="background-image: url('<?php echo base_url($invoice_watermark); ?>');!important;"<?php endif; ?>>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="invoice_table" width="100%">
			...
			<tr>
				<td valign="top" align="right" class="p-l-500 m-t-10 p-10 small_arrow_summ">Sum:</td>
