<table class="table table-striped b-t b-light m-n" id="tbl_Estimated">
	<thead>
	<tr>
		<th width="200px"><a href="#" class="sort" data-status="sent" data-field="client_name" data-type="ASC">
			Client Name<i class="fa fa-filter desc"></i></a></th>
		<th width="350px"><a href="#" class="sort" data-status="sent" data-field="lead_address" data-type="ASC">
			Address<i class="fa fa-filter desc"></i></a></th>
		<th width="90px"><a href="#" class="sort" data-status="sent" data-field="estimate_count_contact" data-type="ASC">
			Count&nbsp;<i class="fa fa-filter desc"></i><br>Contacts</a></th>
		<th width="110px"><a href="#" class="sort" data-status="sent" data-field="estimate_last_contact" data-type="ASC">
			Last&nbsp;&nbsp;&nbsp;<i class="fa fa-filter desc"></i><br>Contact</a></th>
		<th width="110px"><a href="#" class="sort" data-status="sent" data-field="date_created" data-type="ASC">
	...
	<tbody>
	<pre><?php if ($sent_estimate) { ?>
		<?php foreach ($sent_estimate->result() as $rows) { ?>
			<tr>
