<table class="table table-striped b-t b-light m-n" id="tbl_Estimated">
	<thead>
	<tr>
		<th><a href="#" class="sort" data-status="decline_project" data-field="client_name" data-type="ASC">
			Client Name<i class="fa fa-filter desc"></i></a></th>
		<th><a href="#" class="sort" data-status="decline_project" data-field="lead_address" data-type="ASC">
			Address<i class="fa fa-filter desc"></i></a></th>
		<th><a href="#" class="sort" data-status="decline_project" data-field="date_created" data-type="ASC">
	...
	<tbody>
	<?php if ($declined_on_hold_estimate) { ?>
		<?php foreach ($declined_on_hold_estimate->result() as $rows) { ?>
			<tr>
		...
		<?php } ?>
		<?php if ($declined_on_hold_estimate_links) : ?>
			<tr>
				<td colspan="5">
					<div class="pull-right p-sides-10"><?php echo $declined_on_hold_estimate_links; ?></div>
					</div>
			</tr>
		<?php endif; ?>
	<?php } else { ?>
