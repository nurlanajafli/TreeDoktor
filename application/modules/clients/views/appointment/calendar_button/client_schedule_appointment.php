...
$dates = date('Ymd', getTimestamp($task['task_date'])).'T'.date('His', strtotime($task['task_start'])).'/'.date('Ymd', getTimestamp($task['task_date'])).'T'.date('His', strtotime($task['task_end']));
