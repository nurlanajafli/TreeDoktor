		...
		<?php for($i = $week_start_time; $i <= $week_end_time; $i += 86400) : ?>
			<?php if(date('N', $i) != 7 || date('N', $week_start_time) == 7) : ?>
				...
				<?php //if(isset($worked_data[$i]->team)) : ?>
					...
					<td class="text-center v-top day-report-column" style="padding: 0">
							...
							<tbody>
								...
								<tr>
									<td class="text-center" style="white-space: nowrap;border-left: 0;">
										...
										<?php echo isset($teams[$teamDate]['team_estimated_hours']) ? $teams[$teamDate]['team_estimated_hours'] . ' mhr.' : 'N\A'; ?>
										</span>
									</td>
									<td class="text-center" style="white-space: nowrap;border-right: 0">
										
										<span class="actual-manhours">
										<?php echo isset($teams[$teamDate]['team_man_hours']) ? $teams[$teamDate]['team_man_hours'] . ' mhr.' : 'N\A'; ?>
										</span>
									</td>
								...
								<tr>
									<td class="text-center" style="border-left: 0">
										<span class="estimated-per-hour"><?php echo money((isset($teams[$teamDate]['team_estimated_amount']) && isset($teams[$teamDate]['team_estimated_hours']) && $teams[$teamDate]['team_estimated_hours']) ? round($teams[$teamDate]['team_estimated_amount'] / $teams[$teamDate]['team_estimated_hours'], 2) : 0); ?> / hr.
										</span>
									</td>
									<td class="text-center" style="border-right: 0">
										<span class="actual-per-hour"><strong><?php echo money((isset($teams[$teamDate]['team_amount']) && isset($teams[$teamDate]['team_man_hours']) && $teams[$teamDate]['team_man_hours']) ? round($teams[$teamDate]['team_amount'] / $teams[$teamDate]['team_man_hours'], 2) : 0); ?> / hr.</strong>
										</span>
									</td>
								...
								<tr style="height: 60px">
									<td class="text-center" style="height: 60px;border-left: 0">
										<span class="estimated-per-hour"><?php echo (isset($events_totals[$teamDate]['planned_travel_time_total'])) ? $events_totals[$teamDate]['planned_travel_time_total'] : 0; ?> hr.
										</span>
									</td>
									<td class="text-center" style="height: 60px;border-right: 0">
										<span class="actual-per-hour"><strong><?php echo (isset($events_totals[$teamDate]['travel_time_total'])) ? round($events_totals[$teamDate]['travel_time_total']/3600, 2) : 0; ?> hr.</strong>
										</span>
									</td>
									<?php /*<td class="text-center" style="">
										<span class="per-hour-productivity">-%</span>
								...
								<tr style="height: 60px">
									<td class="text-center" style="height: 60px;border-left: 0;">
										<span class="estimated-per-hour"><?php echo (isset($events_totals[$teamDate]['planned_service_time_total'])) ? $events_totals[$teamDate]['planned_service_time_total'] : 0; ?>hr.
										</span>
									</td>
									<td class="text-center" style="height: 60px;border-right: 0;">
										<span class="actual-per-hour"><strong><?php echo (isset($events_totals[$teamDate]['on_site_time_total'])) ? round($events_totals[$teamDate]['on_site_time_total']/3600, 2):0; ?> hr.</strong>
										</span>
									</td>
									<?php /*<td class="text-center" style="">
										<span class="per-hour-productivity">-%</span>
