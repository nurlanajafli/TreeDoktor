<div class="row p-5" style="padding-bottom:0; padding-top:0;">
    <div class="col-md-9 m-b-xs text-center"  style="width: 45%; float: left;">
            ...
            <table class="table m-b-none">
                ...
                <tr>
                    ...
                    <td class="b-a text-center">
                        <?php $workPayed = isset($payroll_total_data->worked_payed) && (int)$payroll_total_data->worked_payed ? $payroll_total_data->worked_payed : 1; ?>
                ...
                <tr>
                    ...
                    <td class="b-a text-center">
                        ...
                        <?php if(!isset($pdf)) : ?>
                        <a href="#" title="" class="employeeDeductions" data-html="true" data-placement="top" data-content="<div class='text-center'><input type='text' class='m-n deductionsSum' style='width: 50px;height: 21px;padding: 6px;' value='<?php echo $deduction_amount; ?>'><a class='btn btn-xs btn-info m-l-xs saveDeduction' title='Change' data-payroll_id='<?php echo $payroll_id; ?>' data-employee_id='<?php echo $employee_id; ?>' data-deduction_id='<?php echo $deduction_id; ?>'><i class='fa fa-check'></i></a></div>" data-original-title="Deductions<button type=&quot;button&quot;class=&quot;m-l-sm close pull-right&quot; data-dismiss=&quot;popover&quot;>×</button>">
                        <?php endif; ?>
    ...
    <div class="col-md-3 text-right"  style="width: 45%; float: right;">
        <div class="table-responsive">
            <table class="table m-b-none">
                <tbody>
                ...
                <tr>
                    ...
                    <td class="b-a text-center">
                        ...
                        <?php echo money($bld_total_origin); ?>
                    </td>
                </tr>
                <tr>
                    <td class="bg-light font-bold b-a text-right" style="font-weight: bold; background: #f1f1f1;color: #717171;">
                    ...
                    <td class="b-a text-center">
                        ...
                        <?php echo money($extra_total_origin); ?>
                    </td>
                </tr>
                <tr>
                    <td class="bg-light font-bold b-a text-right" style="font-weight: bold; background: #f1f1f1;color: #717171;">
