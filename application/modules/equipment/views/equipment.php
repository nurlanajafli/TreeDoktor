...
<ul class="breadcrumb no-border no-radius b-b b-light">
    ...
    <li class="active">Equipment <?php echo $group ? "in " . $group->group_name : ""; ?></li>
</ul>
<section id="equipment" diez-app="EquipmentsApp" diez-src="equipment/components/equipment.js"
        ...
        <div class="table-responsive">
            ...
            <table class="table" id="tbl_search_result">
                ...
                <tr>
                    ...
                    <th class="sortable" data-sort="eq_code">Code</th>
                    <th class="sortable" data-sort="eq_serial">Serial</th>
                    <th class="sortable" data-sort="eq_description">Description</th>
                    <th class="sortable" data-sort="last_counter">Last <?php echo DISTANCE_MEASUREMENT; ?>/hrs</th>
                    <th class="sortable" data-sort="eq_created_at">Created On</th>
                    <th class="sortable" data-sort="eq_repair">Repair Status</th>
                    <th>Actions</th>
                </tr>
                </thead>
...
<?php $this->load->view_hb('equipment_row'); ?>
