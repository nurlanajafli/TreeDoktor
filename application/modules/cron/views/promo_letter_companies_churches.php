...
<body style="Margin:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;min-width:100%;background-color:#ffffff;" >
	...
	<p style="font-size: 16px;">
		My name is Allan and I am an ISA Certified Arborist and Estimator for Tree Doctors located in Toronto.
	</p>

    <p style="font-size: 16px;">
        Right now we have a promotion that I think you might be interested in. From February 1st until April 1st, 2018, we are offering free arborist safety inspection and 10% off any tree services in GTA.
    </p>

	<p style="font-size: 16px;">
		Tree Doctors is the most reliable, experienced and professional tree care provider in the City. Our friendly crews can help to improve the visual aesthetics of your building and improve safety for your members by removing tripping/injury hazards and tidying up unsightly branches, trees, and shrubs. 
	</p>
	...
	<ul style="font-size: 16px; margin-top: 0;">
		<li>24-Hour Emergency Service for dead, dying, and dangerous Trees</li>
		<li>Tree and hedge pruning</li>
		<li>Tree removal and stump grinding</li>
		<li>Plant health care and integrated pest management treatments</li>
		<li>Arborist reports and consultations</li>
	</ul>

	<p style="font-size: 16px;">
		We have built and maintain our reputation for reliability through each and every job we complete. We are known for our high-quality work and budget-friendly pricing. Our portfolio of clients includes the City of Toronto, T.T.C., Ontario Place, Crosslinx, along with developers, architects, small businesses, and large corporations. All of our work is covered by full-range liability insurance for up to $5,000,000. Check out what our customers have to say.
	</p>

	<p style="font-size: 16px;">
		I would be happy to provide a free, no obligation estimate for any of your current needs. I can be reached at 416-201-8000 or by email at info@treedoctors.ca.
	</p>
