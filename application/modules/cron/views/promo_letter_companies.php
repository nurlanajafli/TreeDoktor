...
<body style="Margin:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;min-width:100%;background-color:#ffffff;" >
    ...
    <p style="font-size: 16px;">
        My name is Dave Gilbert and I’m an Arborist and Estimator here at Tree Doctors. Our qualified professional staff have worked within numerous cemeteries throughout Toronto and the GTA, maintaining and treating trees, while prioritizing safety and care around monuments and other valuable property. We have an extensive range of equipment designed to accommodate the most sensitive sites.
    </p>

    <ul style="font-size: 16px; margin-top: 0;">
        Our existing clients trust Tree Doctor’s I.S.A. Certified staff to:
        <li>Provide condition and tree risk assessments</li>
        <li>Perform cabling and bracing for tree preservation</li>
        <li>Develop pruning plans and propose yearly maintenance</li>
        <li>Diagnose and treat insect and disease problems for woody ornamentals</li>
        <li>Develop plant health care management plans (Integrated Pest Management)</li>
        <li>Provide advise for species selection and planting locations</li>
    </ul>

    <p style="font-size: 16px;">
        Right now, until the end of March, Tree Doctors is offering a free safety inspection for the trees on your property. Inspections are performed by an I.S.A. Certified Arborist who will recommend action for dead/dying trees, dead/broken limbs, and any trees with major defects, especially in high traffic areas on your site.
    </p>

    <p style="font-size: 16px;">
        Want a more comprehensive maintenance plan? We are happy to work with property management and within site budgets to prioritize tree work so you get the most from your money, keeping trees safe and healthy for your visitors.
    </p>
    
    <p style="font-size: 16px;">
        Please let us know when we can set up your free safety inspection!
    </p>
    ...
    <div class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;" >
        <div class="webkit" style="max-width:600px;" >
            ...
            <tr>
                <td class="one-column signature" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#fff;background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;" >
                   <?php echo $signature; ?>
                </td>
            </tr>
