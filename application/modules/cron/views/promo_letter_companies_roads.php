...
<body style="Margin:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;min-width:100%;background-color:#ffffff;" >
	...
	<p style="font-size: 16px;">
		Our services can help to improve the efficiency and safety of your road crew teams by removing and managing natural (tree/shrub) obstacles that are encountered during road work or other construction projects.
	</p>
	...
	<ul style="font-size: 16px; margin-top: 0;">
		...
		<li>Clearance pruning for tree limbs</li>
		<li>Root pruning and root sensitive excavation (Airspading & Hydro-vac)</li>
		<li>Tree removal and stump grinding</li>
		<li>Construction arborist reports, tree protection plans and consulting services</li>
	</ul>
