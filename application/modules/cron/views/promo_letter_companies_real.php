...
<body style="Margin:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;min-width:100%;background-color:#ffffff;" >
	...
	<p style="font-size: 16px;">
		My name is Allan and I am an ISA Certified Arborist and Estimator with Tree Doctors located in Toronto.
	</p>

    <p style="font-size: 16px;">
       Tree Doctors is the most reliable, experienced and professional tree care provider in the City of Toronto.
    </p>

    <p style="font-size: 16px;">
        Our services can help to improve the exterior of your client's homes and increase the value of a property by removing/pruning dead or unsightly trees/shrubs/branches. 
    </p>
	...
	<ul style="font-size: 16px; margin-top: 0;">
		<li>Tree and shrub planting along with basic planting design</li>
		<li>Tree pruning</li>
		<li>Tree removal and stump grinding</li>
		<li>Plant health care and integrated pest management</li>
