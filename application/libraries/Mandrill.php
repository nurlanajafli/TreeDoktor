...
require_once APPPATH . 'libraries/Mandrill/Templates.php';
require_once APPPATH . 'libraries/Mandrill/Exports.php';
require_once APPPATH . 'libraries/Mandrill/Users.php';
require_once APPPATH . 'libraries/Mandrill/Rejects.php';
require_once APPPATH . 'libraries/Mandrill/Inbound.php';
require_once APPPATH . 'libraries/Mandrill/Tags.php';
require_once APPPATH . 'libraries/Mandrill/Messages.php';
require_once APPPATH . 'libraries/Mandrill/Whitelists.php';
require_once APPPATH . 'libraries/Mandrill/Ips.php';
require_once APPPATH . 'libraries/Mandrill/Internal.php';
require_once APPPATH . 'libraries/Mandrill/Subaccounts.php';
require_once APPPATH . 'libraries/Mandrill/Urls.php';
require_once APPPATH . 'libraries/Mandrill/Webhooks.php';
require_once APPPATH . 'libraries/Mandrill/Senders.php';
require_once APPPATH . 'libraries/Mandrill/Metadata.php';
require_once APPPATH . 'libraries/Mandrill/Exceptions.php';
