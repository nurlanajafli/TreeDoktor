...
class PaymentException extends \Exception
{
     ...
     * @param bool|array $tresponse
     */
    public function __construct($message, $code = 0, $response = false, $tresponse = false)
    {
     ...
     * @since 5.1.0
     */
    final public function getTransactionResponse() {
